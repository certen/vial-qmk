...
#define R_CURBR KC_SPACE
#define L_CURBR KC_SPACE
#define TRANS KC_SPACE
#define COLON KC_SPACE
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_staggered(
        ...
        KC_0, KC_0,        KC_LEFT, KC_DOWN, KC_RGHT,  KC_LCTL, GUI,   ALT,  KC_NO,  LT(1, KC_ENT),  LT(2, KC_SPC), LT(2, KC_SPC), KC_NO, KC_RALT, KC_RGUI,   KC_RCTL,    RESET
    ),
    ...
    [1] = LAYOUT_staggered(
        ...
        KC_0, KC_0,        KC_LEFT, KC_DOWN,KC_RGHT,  KC_LCTL, GUI,   ALT,  KC_NO,  KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_RALT, KC_RGUI,   KC_RCTL,    RESET
    ),

    [2] = LAYOUT_staggered(
        KC_F7, KC_F8, KC_F9,           KC_GRAVE,     KC_CAPS,    KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_Y,   KC_U,   KC_I,    KC_O,   KC_P,   KC_BSLS,KC_NUHS,
        KC_F4, KC_F5, KC_F6,           KC_NO,      KC_TAB,  KC_PLUS, KC_UNDS, KC_BSLS, COLON,  KC_DLR, KC_H,   KC_J,   KC_K,    KC_L,   KC_SCLN,KC_NO ,  KC_BSPC,
        KC_F1, KC_F2, KC_F3,           TRANS,      LSFT_T(KC_LCBR), KC_NO, KC_EXLM, KC_PERC,KC_BSLASH, KC_AMPR,  KC_AT, KC_CIRCUMFLEX, KC_DQUO,L_CURBR, R_CURBR, KC_SLSH,RSFT_T(KC_RCBR),
        KC_0, KC_0,        TRANS, TRANS,TRANS,  KC_LCTL, GUI,   ALT,  KC_NO,  KC_TRNS,  KC_TRNS, KC_TRNS, KC_NO, KC_RALT, KC_RGUI,   KC_RCTL,    RESET
    )
...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_ESC_CAPS]  = ACTION_TAP_DANCE_DOUBLE(KC_ESCAPE, KC_CAPS)
